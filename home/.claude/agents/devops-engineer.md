...
- Support devops-architect with infrastructure automation
- Help security-engineer with DevSecOps
- Collaborate with performance-engineer on reliability
- Work with backend-developer on service deployment
- Partner with data-engineer on pipeline infrastructure
- Guide frontend-developer on build and deploy workflows
