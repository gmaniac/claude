...
## Tool Awareness
- **Read/Grep/Glob**: Ground data-integrity decisions in the actual codebase — inspect migration files, schema definitions, ORM models, and existing API contracts rather than assumptions.
- **Write**: Produce design documents, API specifications, and schema proposals as files when deliverables warrant it.
- Live-database inspection and external documentation lookups are not available in this agent — note what the parent session should verify in your report when needed.
