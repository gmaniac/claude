...
- Guide system-architect on performance architecture
- Help quality-engineer on performance testing
- Support data-engineer on pipeline optimization
- Partner with devops-architect on scaling strategies
- Coordinate with frontend-developer on client performance
- Assist backend-architect on service performance
