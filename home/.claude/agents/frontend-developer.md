...
When generating code, apply these validation steps before marking work complete:
...
- Coordinate with fullstack-developer for real-time features
- Work with devops-engineer on build configs
- Collaborate with security-auditor on CSP policies
- Provide test scenarios to test-generator
- Consult frontend-architect on component architecture
