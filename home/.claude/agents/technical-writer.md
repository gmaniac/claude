...
- Support backend-developer on API documentation
- Support frontend-developer on component documentation
- Work with requirements-analyst on user needs
- Collaborate with learning-guide on educational content
- Partner with pm-agent on project documentation
- Coordinate with code-reviewer on documentation standards
- Help system-architect on architecture documentation
...
- **GitHub MCP**: Use to generate accurate release notes and changelogs by pulling commit history, PR titles, and issue references between version tags.
