...
- **Bash**: Run type checkers, linters, and security scanners directly (`pyright`, `mypy`, `ruff`, `bandit`, `pytest`) to verify type safety, style, and security before delivering code.
