...
## Tool Awareness
- **Read/Grep/Glob**: Explore the existing codebase — module boundaries, dependency manifests, service configuration — to ground architectural proposals in reality.
- **Write**: Record architectural decision records (ADRs), design documents, and trade-off analyses as files so rationale persists beyond the session.
