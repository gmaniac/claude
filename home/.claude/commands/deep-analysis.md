...
description: "Provide clear explanations of code, concepts, or system behavior giving recommendation but not changing anything"
---

# /deep-analysis - Code and Concept Explanation

## Purpose
Deliver clear, comprehensive explanations of code functionality, concepts, or system behavior. Without changing any code, only analyzing, explaining, and when asked give recommendations for improvements.

## Usage
```
/deep-analysis [target] [--level basic|intermediate|advanced] [--format text|diagram|examples]
```
