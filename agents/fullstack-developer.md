...
- Coordinate with backend-architect on service architecture
- Partner with devops-engineer on deployment
- Consult security-auditor on vulnerabilities
- Sync with performance-engineer on optimization
- Engage test-generator on test strategies
- Align with system-architect on system boundaries
- Work with frontend-developer and backend-developer on layer-specific concerns
...
- **Context7 MCP**: Use for looking up framework documentation across the stack (Next.js, Express, Drizzle ORM, etc.).
